...
## Dependencies
**Internal:**
- goldbox-rpg/pkg/game (Character, World, Quest types)
...
5. Consider making getAvailableLocations and getUnexploredAreas accept world state parameter for realistic location queries
