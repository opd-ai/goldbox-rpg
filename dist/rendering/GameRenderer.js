...
export class GameRenderer extends BaseComponent {
    constructor() {
        ...
        this.animations = new Map(); // TODO: Define animation types
        // Camera system
        this.camera = {
            x: 0,
            y: 0,
            ...
            for (let x = 0; x < viewportWidth; x++) {
                ...
                if (this.isValidMapPosition(map, worldX, worldY)) {
                    ...
                    if (tile) {
                        ...
                        this.drawSprite(this.contexts.terrain, 'terrain', tileSprite.spriteX, tileSprite.spriteY, x * this.tileSize, y * this.tileSize);
                    }
                    else {
    ...
    renderObjects(objects) {
        ...
        objectsArray.forEach((obj) => {
            ...
            if (this.isOnScreen(screenX, screenY)) {
                ...
                this.drawSprite(this.contexts.objects, 'characters', obj.spriteX || 0, obj.spriteY || 0, screenX, screenY);
            }
            else {
    ...
    renderEffects(effects) {
        ...
        effects.forEach((effect) => {
            ...
            if (this.isOnScreen(screenX, screenY)) {
                ...
                this.drawSprite(this.contexts.effects, 'effects', effect.spriteX || 0, effect.spriteY || 0, screenX, screenY);
            }
            else {
     ...
     */
    drawSprite(ctx, spriteName, spriteX, spriteY, destX, destY) {
        ...
        try {
            ctx.drawImage(spriteInfo.image, spriteX * this.tileSize, spriteY * this.tileSize, this.tileSize, this.tileSize, destX, destY, this.tileSize, this.tileSize);
        }
        catch (error) {
